...
function NavBarAdmin() {
  return (
    <div>
      <nav className="bg-gradient-to-r from-red-400 via-gray-300 to-blue-500 ">
          ...
          <div className="relative flex h-16 items-center justify-between">
            ...
            <div className="flex flex-1 items-center justify-center sm:items-stretch sm:justify-start">
              ...
              <Link
                ...
                <Link
                  to="/"
                  className="m-1 inline-flex items-center rounded-md bg-pink-50 px-2 py-1 text-xs font-medium text-pink-700 ring-1 ring-inset ring-pink-700/10"
                >
                  Logout
                </Link>
              </div>
